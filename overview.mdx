...
Vidoc is a platform that handles the infrastructure for you. Scanning is powered by Modules. We improved on the known concept of Templates and **[we wrote our own module engine](/docs/module-scans)**.
...
Understand how Vidoc works and how to use it.
